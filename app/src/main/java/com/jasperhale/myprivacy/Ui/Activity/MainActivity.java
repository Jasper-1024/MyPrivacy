package com.jasperhale.myprivacy.Ui.Activity;
...
import com.jasperhale.myprivacy.Base.BaseActivity;
import com.jasperhale.myprivacy.Base.LogUtil;
import com.jasperhale.myprivacy.Ui.Databind.RecycleAdapter;
import com.jasperhale.myprivacy.ViewModel.MainViewModel;
            ...
            case R.id.menu_show: {
                ...
                switch (show) {
                    case "user":
                        ...
                        break;
                    case "limted":
                        this.menu.findItem(R.id.menu_show_limted).setChecked(true);
                        break;
                    case "system":
            ...
            case R.id.menu_show_all:
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_show_system:
                        ...
                        break;
                    case R.id.menu_show_limted:
                        set_menu_list(getString(R.string.menu_list_limted));
                        break;
                    case R.id.menu_show_all:
